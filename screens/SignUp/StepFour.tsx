...
import { CreateAccountStackParamList } from "../../shared/shared.types";
import {colors} from "../../styles/colors.ts";

type StepFourProps = NativeStackScreenProps<CreateAccountStackParamList, 'StepFour'>;
...
export default function StepFour({navigation}: StepFourProps) {
  ...
  const handleNext = (nextPage: keyof CreateAccountStackParamList) : void => {
