...
interface SignUpAppContextProviderProps {
...
const SignUpAppContext = React.createContext<SignUpAppContextValue> ({} as SignUpAppContextValue);

const SignUpAppContextProvider = ({ children } : SignUpAppContextProviderProps ) => {
  ...
  const [avatarUri, setAvatarUri] : [string|null , React.Dispatch<React.SetStateAction<string|null>>] = useState<string |null>(null);
